...

    {
      ...
      candidates: [
        ...
        { id: 'zudans', name: 'Tracey Lockwood Zudans', party: 'NONPARTISAN',
          ...
          positions: {}, record: [
            { type: 'fact', claim: 'Recused herself from a 2024 city council vote after saying she received an email regarding her county-commission run that she characterized as politically threatening, tied to how she voted.',
              detail: 'Reported during her 2024 County Commission campaign, not her current city council run. Included for completeness on her public record; this guide has not independently reviewed the underlying email or vote.',
              date: '2024-01-01', source: { title: 'The Sunshine Journal (partisan Substack) — reporting on a Vero Beach council recusal', url: 'https://thomasaugustus.substack.com/p/update-mayor-cotugnos-political-failure' } }
        ...
        { id: 'kramer', name: 'Jay Kramer', party: 'NONPARTISAN',
          occupation: 'Not yet documented for 2026',
          bio: 'A former Vero Beach City Council member and two-time former Mayor (2010-2011 and 2015-2016), returning after roughly a decade away from the ballot. This guide located his historical service but no confirmed 2026 platform statements — his older (2010s) positions are not imported here as current. Note: a Jay Kramer has separately been reported as an officer of the Indian River Republican Executive Committee in past coverage; this guide has not confirmed whether that is the same person.',
          positions: {}, record: [], finance: null, endorsements: [], links: {} },
